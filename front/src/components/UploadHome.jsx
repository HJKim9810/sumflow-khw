  ...
  return (
    <section className="space-y-6 max-w-screen-xl mx-auto">
      ...
      <div className="flex flex-wrap items-center gap-3">
        ...
        {/* 숨겨진 input들 */}
        <input type="file" multiple accept={acceptAttr} ref={inputRef} className="hidden" />
        <input type="file" multiple ref={dirInputRef} className="hidden" />
      </div>
      ...
      <div
        className={`
          ...
          ${dragOver ? "border-[#B862FF] bg-purple-50/30" : "border-gray-300 bg-white"}
        `}
        onDragOver={(e) => {
          e.preventDefault();
          setDragOver(true);
        ...
        onDrop={onDrop}
      >
        <div className="text-gray-700 text-sm font-medium">여기에 문서/ZIP/폴더를 드래그해서 추가하세요</div>
      ...
      <div className="space-y-3">
        {items.length === 0 && <div className="text-sm text-gray-400">아직 추가된 문서가 없습니다.</div>}
